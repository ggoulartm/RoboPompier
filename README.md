...
- src: contient les classes fournies par les enseignants
  ...
  -> tests.TestLecteurDonnees.java     : lit un fichier de donnees et affiche son contenu
  -> tests.TestInvader                 : cree un simulateur "mini Invaders" dans une fenetre graphique

- cartes: quelques exemples de fichiers de donnees

- bin/gui.jar: archive Java contenant les classes de l'interface graphique. Voir un exemple d'utilisation dans tests.TestInvader.java
